...
function ale_enqueue_styles() {
	...
	wp_register_style( 'aletheme-olins-shortcodes-css', ALETHEME_THEME_URL . '/css/olins_shortcodes.css', array(), ALETHEME_THEME_VERSION, 'all');
	...
	wp_register_style( 'aletheme-creative-css', ALETHEME_THEME_URL . '/css/variants/creative.css', array('aletheme-general-css'), ALETHEME_THEME_VERSION, 'all');
